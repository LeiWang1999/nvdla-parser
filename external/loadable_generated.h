...
namespace nvdla {
    namespace loadable {
        ...
        inline const LoadableVersionMajor (&EnumValuesLoadableVersionMajor())[1] {
            static const LoadableVersionMajor values[] = {
                    LoadableVersionMajor_VAL
            };
            return values;
        }

        inline const char * const *EnumNamesLoadableVersionMajor() {
            static const char * const names[] = {
                    "VAL",
                    nullptr
            };
        ...
        inline const LoadableVersionMinor (&EnumValuesLoadableVersionMinor())[1] {
            static const LoadableVersionMinor values[] = {
                    LoadableVersionMinor_VAL
            };
            return values;
        }

        inline const char * const *EnumNamesLoadableVersionMinor() {
            static const char * const names[] = {
                    "VAL",
                    nullptr
            };
        ...
        inline const LoadableVersionSubMinor (&EnumValuesLoadableVersionSubMinor())[1] {
            static const LoadableVersionSubMinor values[] = {
                    LoadableVersionSubMinor_VAL
            };
            return values;
        }

        inline const char * const *EnumNamesLoadableVersionSubMinor() {
            static const char * const names[] = {
                    "VAL",
                    nullptr
            };
        ...
        inline const EventType (&EnumValuesEventType())[3] {
            static const EventType values[] = {
                    EventType_EVENTTYPE0,
                    EventType_EVENTTYPE1,
                    EventType_EVENTTYPE2
            };
            return values;
        }
        ...
        inline const EventOp (&EnumValuesEventOp())[2] {
            static const EventOp values[] = {
                    EventOp_WAIT,
                    EventOp_SIGNAL
            };
            return values;
        ...
        inline const char * const *EnumNamesEventOp() {
            static const char * const names[] = {
                    "WAIT",
                    "SIGNAL",
                    nullptr
        ...
        inline const DataFormat (&EnumValuesDataFormat())[3] {
        ...
        inline const DataCategory (&EnumValuesDataCategory())[5] {
            static const DataCategory values[] = {
                    DataCategory_IMAGE,
                    DataCategory_WEIGHT,
                    DataCategory_FEATURE,
                    DataCategory_PLANAR,
                    DataCategory_BIAS
            };
            return values;
        ...
        inline const char * const *EnumNamesDataCategory() {
            static const char * const names[] = {
                    "IMAGE",
                    "WEIGHT",
                    "FEATURE",
        ...
        inline const PixelMapping (&EnumValuesPixelMapping())[2] {
            static const PixelMapping values[] = {
                    PixelMapping_PITCH_LINEAR,
                    PixelMapping_INVALID_PIXEL_MAP
            };
            return values;
        }

        inline const char * const *EnumNamesPixelMapping() {
            static const char * const names[] = {
                    "PITCH_LINEAR",
                    "INVALID_PIXEL_MAP",
                    nullptr
        ...
        inline const PixelFormat (&EnumValuesPixelFormat())[37] {
            static const PixelFormat values[] = {
                    ...
                    PixelFormat_X16B16G16R16,
                    PixelFormat_A16B16G16R16_F,
                    PixelFormat_A16Y16U16V16,
                    PixelFormat_V16U16Y16A16,
                    PixelFormat_A16Y16U16V16_F,
                    PixelFormat_A8B8G8R8,
                    PixelFormat_A8R8G8B8,
                    PixelFormat_B8G8R8A8,
                    PixelFormat_R8G8B8A8,
                    PixelFormat_X8B8G8R8,
                    PixelFormat_X8R8G8B8,
                    PixelFormat_B8G8R8X8,
                    PixelFormat_R8G8B8X8,
                    PixelFormat_A2B10G10R10,
                    PixelFormat_A2R10G10B10,
                    PixelFormat_B10G10R10A2,
                    PixelFormat_R10G10B10A2,
                    PixelFormat_A2Y10U10V10,
                    PixelFormat_V10U10Y10A2,
                    PixelFormat_A8Y8U8V8,
                    PixelFormat_V8U8Y8A8,
                    PixelFormat_Y8_U8V8_N444,
                    PixelFormat_Y8_V8U8_N444,
                    PixelFormat_Y10_U10V10_N444,
                    PixelFormat_Y10_V10U10_N444,
                    PixelFormat_Y12_U12V12_N444,
                    PixelFormat_Y12_V12U12_N444,
                    PixelFormat_Y16_U16V16_N444,
                    PixelFormat_Y16_V16U16_N444,
                    PixelFormat_FEATURE
            };
            return values;
        }
...
struct EventListEntryBuilder {
    ...
    explicit EventListEntryBuilder(flatbuffers::FlatBufferBuilder &_fbb)
            : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_PRE_ACTIONS) &&
           verifier.VerifyVector(pre_actions()) &&
           VerifyOffset(verifier, VT_POST_ACTIONS) &&
           verifier.VerifyVector(post_actions()) &&
           verifier.EndTable();
}
};
...
struct SubmitListEntryBuilder {
    ...
    explicit SubmitListEntryBuilder(flatbuffers::FlatBufferBuilder &_fbb)
            : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct TensorDescListEntryBuilder {
    ...
    explicit TensorDescListEntryBuilder(flatbuffers::FlatBufferBuilder &_fbb)
            : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
struct RelocListEntryBuilder {
    ...
    explicit RelocListEntryBuilder(flatbuffers::FlatBufferBuilder &_fbb)
            : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyOffset(verifier, VT_EVENT_LIST) &&
           verifier.VerifyVector(event_list()) &&
           ...
           VerifyOffset(verifier, VT_TENSOR_DESC_LIST) &&
           verifier.VerifyVector(tensor_desc_list()) &&
           verifier.VerifyVectorOfTables(tensor_desc_list()) &&
           VerifyOffset(verifier, VT_RELOC_LIST) &&
           verifier.VerifyVector(reloc_list()) &&
           verifier.VerifyVectorOfTables(reloc_list()) &&
           VerifyOffset(verifier, VT_SUBMIT_LIST) &&
           verifier.VerifyVector(submit_list()) &&
...
struct LoadableBuilder {
    ...
    explicit LoadableBuilder(flatbuffers::FlatBufferBuilder &_fbb)
            : fbb_(_fbb) {
        start_ = fbb_.StartTable();
    }
...
inline const nvdla::loadable::Loadable *GetSizePrefixedLoadable(const void *buf) {
    return flatbuffers::GetSizePrefixedRoot<nvdla::loadable::Loadable>(buf);
}
...
inline bool VerifySizePrefixedLoadableBuffer(
        flatbuffers::Verifier &verifier) {
    return verifier.VerifySizePrefixedBuffer<nvdla::loadable::Loadable>(nullptr);
}
...
inline void FinishSizePrefixedLoadableBuffer(
        flatbuffers::FlatBufferBuilder &fbb,
        flatbuffers::Offset<nvdla::loadable::Loadable> root) {
